...
ax.set_title('Performance Evaluation after Adding Noise - Small Models with Baseline')
plt.tight_layout()
plt.savefig("plots/performance_evaluation_after_adding_noise_with_baseline-small.png")